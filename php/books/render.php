...
foreach ($data as $items) {
    ...
    $table .= '<td>';
    $table .= '<button class="btn btn-light btn-sm" data-element-id="' . $items['book_id'] . '">Редактировать</button>';
    $table .= '<button class="btn btn-danger btn-sm" data-element-id="' . $items['book_id'] . '">Удалить</button>';
    $table .= '</td>';
    $table .= '</tr>';
}
echo $table;